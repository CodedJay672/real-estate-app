    ...
    <>
      <div className="min-h-screen bg-[#050505] text-white selection:bg-yellow-500 selection:text-black font-sans">
        ...
        <footer className="py-20 text-center px-6">
          ...
          <div className="text-center px-10 py-8 border border-yellow-500/20 rounded-3xl bg-yellow-500/20 mt-6 max-w-sm mx-auto">            <p className="text-[10px] uppercase tracking-[0.4em] mb-3 text-gray-400">Marketed Exclusively By</p>
