      ...
      <div className="relative container mx-auto flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="mt-10 sm:mt-12 flex flex-col items-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
          <div className="flex -space-x-3">
            <img src="https://i.pravatar.cc/100?img=1" alt="Client" className="w-10 h-10 rounded-full border-2 border-[#0f172a] object-cover" />
            <img src="https://i.pravatar.cc/100?img=2" alt="Client" className="w-10 h-10 rounded-full border-2 border-[#0f172a] object-cover" />
            <img src="https://i.pravatar.cc/100?img=3" alt="Client" className="w-10 h-10 rounded-full border-2 border-[#0f172a] object-cover" />
            <img src="https://i.pravatar.cc/100?img=4" alt="Client" className="w-10 h-10 rounded-full border-2 border-[#0f172a] object-cover" />
