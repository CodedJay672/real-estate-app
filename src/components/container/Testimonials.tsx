const Testimonials = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[url(/assets/happy-woman.jpg)] bg-cover bg-center bg-fixed py-24">
      <div className="absolute inset-0 bg-gradient-to-br from-[#f5c344]/95 via-amber-500/95 to-[#b88f3a]/95" />
      <div className="relative container mx-auto px-4 text-center">
        <div className="mx-auto max-w-3xl space-y-5">
          <p className="text-sm uppercase tracking-[0.3em] text-amber-950 font-bold">Client Success Stories</p>
          <h1 className="text-3xl font-extrabold sm:text-4xl lg:text-5xl text-slate-950">
            Trusted by Investors Worldwide.
          </h1>
          <p className="mx-auto max-w-2xl text-base leading-8 text-slate-850 sm:text-lg font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-7xl mx-auto">
          {reviews.map((review, idx) => (
            <figure key={idx} className="rounded-3xl border border-[#b88f3a]/20 bg-[#0f172a] p-8 sm:p-10 shadow-2xl relative overflow-hidden group flex flex-col hover:-translate-y-2 transition-transform duration-300 text-left">
              <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-[#f5c344] via-amber-200 to-[#b88f3a]" />
              <div className="flex justify-center mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#f5c344] to-[#b88f3a] text-xl tracking-[0.2em] drop-shadow-sm">
                ★★★★★
              </div>
              ...
              <figcaption className="mt-8 flex flex-col items-center justify-center gap-1 border-t border-white/10 pt-6">
                <span className="block text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#f5c344] to-[#b88f3a] uppercase tracking-wider">{review.name}</span>
