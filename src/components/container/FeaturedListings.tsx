...
const FeaturedListings = () => {
  return (
    <section className="flex-center flex-col bg-blue-50 max-h-max px-2 py-10 my-4">
      <h2 className="text-2xl md:text-3xl font-bold text-center">
        Why Choose Us?
      </h2>
      <p className="text-center mt-4 w-full max-w-lg mx-auto my-10">
      ...
      <div className="mt-4 flex justify-center items-center">
        <Button className="h-14 text-gold font-medium bg-blue-300">
