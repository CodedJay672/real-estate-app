          ...
          {blogPosts.map((post, idx) => (
            <article key={idx} className="w-[320px] md:w-[420px] bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:-translate-y-2 hover:border-[#b88f3a]/30 transition-all duration-300 group flex flex-col shrink-0 whitespace-normal">
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <h3 className="text-xl font-bold text-[#0f172a] mb-4 group-hover:text-[#b88f3a] transition-colors leading-snug line-clamp-2">
                  {post.title}
                </h3>
                ...
                <Link href={`/blog/${post.slug}`} className="inline-flex items-center gap-2 text-sm font-bold text-[#0f172a] group-hover:text-[#b88f3a] transition-colors mt-auto uppercase tracking-wider cursor-pointer">
